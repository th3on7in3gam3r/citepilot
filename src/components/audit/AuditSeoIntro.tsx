      ...
      <details className="group">
        <summary className="flex cursor-pointer list-none items-center gap-2 select-none">
          <span className="font-display text-sm font-semibold text-ink">
            How does the citation audit work?
          </span>
          <span className="text-xs text-muted transition-transform group-open:rotate-90" aria-hidden>
            ▶
          </span>
        </summary>

        <article className="mt-6 space-y-8 border-l-2 border-border pl-5 text-sm leading-relaxed text-muted">
          <section>
