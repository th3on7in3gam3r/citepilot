    ...
    <section className="hero-premium relative overflow-hidden" aria-labelledby="hero-heading">
      ...
      <Container className="relative z-10 px-4 pt-[5.25rem] pb-10 sm:pt-24 sm:pb-12 md:pt-28 md:pb-14">
        <header className="hero-rise mx-auto max-w-3xl text-center lg:max-w-4xl">
          <p className="font-display text-sm font-bold tracking-[0.14em] text-white/70 uppercase sm:text-base">
            {t("brand")}
          </p>

          <h1
            id="hero-heading"
            className="mt-3 font-display text-[2rem] font-bold leading-[1.1] tracking-[-0.02em] text-foreground dark:text-white sm:mt-4 sm:text-[2.75rem] md:text-[3.25rem] lg:text-[3.5rem]"
          >
            {t("headline")}
        ...
        <div
          ...
          className="hero-rise hero-rise-delay-3 mx-auto mt-10 max-w-3xl rounded-2xl border border-white/10 bg-white/[0.06] p-5 text-left backdrop-blur-sm sm:mt-12"
