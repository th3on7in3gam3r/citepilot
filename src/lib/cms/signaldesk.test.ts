...
describe("signaldesk", () => {
  ...
  it("marks CitePilot attribution meta and appends footer HTML", () => {
    const body = buildSignalDeskPublishBody({
      siteUrl: "https://desk.example",
      title: "GEO score guide",
      slug: "geo-score-guide",
      html: "<p>Body</p>",
      description: "A practical guide to improving AI citation rates across ChatGPT and Perplexity.",
      coverImageUrl: "https://cdn.example.com/cover.jpg",
    });
    expect(body.meta.citepilot).toBe(true);
    expect(body.meta.source).toBe("citepilot");
    expect(body.content).toContain('data-citepilot-attribution="1"');
    expect(body.content).toContain("Generated by");
    expect(body.content).toContain("getcitepilot.com");

    const again = buildSignalDeskPublishBody({
      siteUrl: "https://desk.example",
      title: "GEO score guide",
      slug: "geo-score-guide",
      html: body.content,
    ...
    expect(again.content.match(/data-citepilot-attribution/g)?.length).toBe(1);
  });
});
